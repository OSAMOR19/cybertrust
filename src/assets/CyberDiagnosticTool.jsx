...
// Custom Alert Component using Tailwind
  ...
  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
    <div className="flex items-center">
      ...
      <div className="ml-3">
        ...
        <div className="mt-2 text-sm text-yellow-700">{description}</div>
      </div>
    </div>
    {children}
  </div>
...
const CyberDiagnosticTool = () => {
  ...
  const slides = [
    // Slide 1: Welcome
    <div key="welcome" className="space-y-9 mt-11">
      <h2 className="text-2xl font-bold text-center mb-4">Cyber Security Diagnostic Tool</h2>
      <Alert 
        title="Important Notice"
        description="This tool helps you identify potential cyber attacks and guides you through the reporting process."
      />
